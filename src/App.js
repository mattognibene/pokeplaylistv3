...
const redirectUri = "https://mattognibene.github.io/pokeplaylistv3/";//'https://pokeplaylist.herokuapp.com'
const scopes = [
    "user-top-read"
];
            ...
            <div>
                {!this.state.token && (
                    <div className="login_container">
                        ...
                        <div className="created_by_container">Created by Matt Ognibene</div>
                        </div>
                )}
                {this.state.token && (
